...
CREATE TABLE customers(
	number_identification VARCHAR(30) NOT NULL,
    full_name_customer VARCHAR(100),
    phone_customer VARCHAR(30),
    address TEXT,
    email VARCHAR(150),
    PRIMARY KEY(number_identification)
);

CREATE TABLE INVOICES(
	number_bill VARCHAR(20) NOT NULL,
...
INSERT INTO invoices (ID_number_bill, mount_bill, period_bill)
VALUES
